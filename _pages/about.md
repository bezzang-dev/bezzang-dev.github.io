...
개미와 베짱이 이야기를 아시나요?
베짱이는 개미들이 열심히 일을 하는 동안 기타를 치고 있습니다.

저는 취미로 통기타 연주를 합니다. 스트레스를 받거나 피로가 쌓이면 기타 연주로 풀곤 했습니다.
...
주로 PS, 네트워크, 데이터베이스, 백엔드에 대해 공부했던 내용들을 게시하려 합니다.
특히 백엔드는 Spring 프레임워크를 위주로 다룹니다.
